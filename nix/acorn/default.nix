...
let
 bundle-dna = (pkgs.writeShellScriptBin "acorn-bundle-dna" ''
  ...
  # default to 0.4.1
  echo "fetching DNA from https://github.com/h-be/acorn-hc/releases/download/v''${1:-0.4.1}/profiles.dna.gz"
  echo "fetching DNA from https://github.com/h-be/acorn-hc/releases/download/v''${1:-0.4.1}/projects.dna.gz"
  curl -O -L https://github.com/h-be/acorn-hc/releases/download/v''${1:-0.4.1}/profiles.dna.gz
  curl -O -L https://github.com/h-be/acorn-hc/releases/download/v''${1:-0.4.1}/projects.dna.gz
  mkdir dna
 ...
 bundle-ui = (pkgs.writeShellScriptBin "acorn-bundle-ui" ''
  ...
  # an optional first argument should be the version number you want
  # default to 0.4.2
  curl -O -L https://github.com/h-be/acorn-ui/releases/download/v''${1:-0.4.2}/acorn-ui.zip
